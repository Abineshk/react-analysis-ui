        ...
        <div className="flex items-center justify-between">
          ...
          {username && (
            <div className="relative" ref={dropdownRef}>
              ...
              {/* Dropdown Menu */}
              {isDropdownOpen && (
                <div className="absolute right-0 mt-3 w-64 bg-white rounded-xl shadow-2xl border border-purple-100 py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <button
                    className="w-full px-4 py-2.5 text-left text-gray-700 hover:bg-purple-50 flex items-center gap-3 transition-colors rounded-lg mx-1"
                  ...
                  <div className="border-t border-purple-100 mt-2 pt-2">
                    <button
                      className="w-full px-4 py-2.5 text-left text-red-600 hover:bg-red-50 flex items-center gap-3 transition-colors rounded-lg mx-1"
                      onClick={() => {
                        setIsDropdownOpen(false);
                        logout();
                      }}
